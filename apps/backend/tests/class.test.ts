...
describe("Class Service", () => {
  ...
  describe("list", () => {
    ...
    it("returns all classes with relations", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-2025/2026" } });
    ...
    it("orders by year descending then name ascending", async () => {
      const year1 = await prisma.academicYear.create({ data: { year: "C-2024/2025" } });
      const year2 = await prisma.academicYear.create({ data: { year: "C-2025/2026" } });
  ...
  describe("getById", () => {
    it("returns class by id with all relations", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-GBI-2025/2026" } });
      ...
      expect(found.academicYear.year).toBe("C-GBI-2025/2026");
    });
    ...
    it("returns null homeroomTeacher when not assigned", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-GBI-2026/2027" } });
  ...
  describe("create", () => {
    it("creates a class", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-CR-2025/2026" } });
    ...
    it("rejects duplicate class name in same year", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-CR-2027/2028" } });
    ...
    it("allows same class name in different year", async () => {
      const y1 = await prisma.academicYear.create({ data: { year: "C-CR-2030/2031" } });
      const y2 = await prisma.academicYear.create({ data: { year: "C-CR-2031/2032" } });
  ...
  describe("getStudents", () => {
    it("returns students for a class", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-GS-2025/2026" } });
      const cls = await prisma.class.create({ data: { name: "Kelas 5A", academicYearId: year.id } });
      await prisma.student.create({ data: { name: "S1", classId: cls.id, nis: "CGS-1001", nisn: "CGS-001001", gender: "L" } });
      await prisma.student.create({ data: { name: "S2", classId: cls.id, nis: "CGS-1002", nisn: "CGS-001002", gender: "P" } });
      const students = await service.getStudents(cls.id);
      expect(students.length).toBe(2);
    });

    it("returns students sorted by name", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-GS-2025/2026B" } });
      const cls = await prisma.class.create({ data: { name: "Kelas 5B", academicYearId: year.id } });
      await prisma.student.create({ data: { name: "Z", classId: cls.id, nis: "CGS-2001", nisn: "CGS-002001", gender: "L" } });
      await prisma.student.create({ data: { name: "A", classId: cls.id, nis: "CGS-2002", nisn: "CGS-002002", gender: "P" } });
      const students = await service.getStudents(cls.id);
    ...
    it("returns empty array for class with no students", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-GS-2026/2027" } });
  ...
  describe("assignTeacher", () => {
    it("assigns homeroom teacher and creates audit log", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-AT-2025/2026" } });
    ...
    it("replaces existing teacher and logs previous", async () => {
      const year = await prisma.academicYear.create({ data: { year: "C-AT2-2025/2026" } });
